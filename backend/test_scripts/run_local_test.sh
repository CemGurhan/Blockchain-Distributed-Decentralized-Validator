...
validator_reciever_port=6336
peer_reciever_flag=""
peer_reciever_port=6337
current_reciever_port=6336

if [[ validator_reciever_port -eq 6336 ]]
then
...
for i in $(seq 1 $(($number_of_validators - 1))); do
    ...
    echo $peer_reciever_flag
    ttab -w eval "sh test_scripts/configure_node.sh -n $number_of_validators -p 0.0.0.0:$(($validator_peer_port+$i)) -o $(($validator_public_port+$i)) -t $(($validator_private_port+$i)) -r $(($validator_reciever_port+$i)) $peer_reciever_flag"
    validator_reciever_port=6336
...
#     while [ $current_reciever_port -lt $((6336 + $number_of_validators)) ]
#     do
#         peer_reciever_flag=""
#         peer_reciever_flag+="-a 0.0.0.0:"
#         peer_reciever_port=$validator_reciever_port
