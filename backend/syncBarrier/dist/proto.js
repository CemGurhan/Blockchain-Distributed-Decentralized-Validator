...
(function (global, factory) {
    ...
    $root.Model = function () {
        ...
        Model.encode = function encode(message, writer) {
            ...
            if (message.score != null && Object.hasOwnProperty.call(message, "score")) writer.uint32( /* id 4, wireType 5 =*/37).float(message.score);
            if (message.min_score != null && Object.hasOwnProperty.call(message, "min_score")) writer.uint32( /* id 5, wireType 5 =*/45).float(message.min_score);
            return writer;
        };
        ...
        Model.verify = function verify(message) {
            ...
            if (message.min_score != null && message.hasOwnProperty("min_score")) if (typeof message.min_score !== "number") return "min_score: number expected";
            return null;
        };
        ...
        Model.fromObject = function fromObject(object) {
            ...
            if (object.min_score != null) message.min_score = Number(object.min_score);
            return message;
        };
        ...
        Model.toObject = function toObject(message, options) {
            ...
            if (message.min_score != null && message.hasOwnProperty("min_score")) object.min_score = options.json && !isFinite(message.min_score) ? String(message.min_score) : message.min_score;
            return object;
        };
    ...
    $root.TxSyncBarrier = function () {
        ...
        TxSyncBarrier.encode = function encode(message, writer) {
            if (!writer) writer = $Writer.create();
            if (message.seed != null && Object.hasOwnProperty.call(message, "seed")) writer.uint32( /* id 1, wireType 0 =*/8).uint64(message.seed);
            return writer;
        };
        ...
        TxSyncBarrier.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.TxSyncBarrier();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        TxSyncBarrier.fromObject = function fromObject(object) {
            if (object instanceof $root.TxSyncBarrier) return object;
